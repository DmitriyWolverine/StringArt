...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/logo1-106x61.jpg" type="image/x-icon">
            ...
            <div class="media-content col-md-10">
                ...
                <div class="mbr-section-btn align-center">
	                <form action="MyServlet" method="post">
		               	<button class="btn btn-md btn-info-outline display-4" type="hidden" name="action" value="show_artists">
		               		Show artists
		               	</button>
					</form>
					
					 <form action="MyServlet" method="post">
		               	<button class="btn btn-md btn-secondary-outline display-4" type="hidden" name="action" value="show_styles">
		               		Show styles
		               	</button>
					</form>
