...
<head>
  ...
  <link href="<c:url value="/assets/images/logo1-106x61.jpg" />" rel="shortcut icon" type="image/x-icon">
  <meta name="description" content="">
  <title>Home</title>
  <link href="<c:url value="/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/web/assets/mobirise-icons/mobirise-icons.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/tether/tether.min.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/bootstrap/css/bootstrap.min.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/bootstrap/css/bootstrap-grid.min.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/bootstrap/css/bootstrap-reboot.min.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/dropdown/css/style.css"/>" rel="stylesheet"> 
  <link href="<c:url value="/assets/theme/css/style.css" />" rel="stylesheet">
  <link href="<c:url value="/assets/mobirise/css/mbr-additional.css"  />" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" href="https://mobirise.com"><span class="mbrib-change-style mbr-iconfont mbr-iconfont-btn"></span>
                        Anthony Shad</a></span>
            </div>
        </div>
...
<section class="engine"><a href="https://mobirise.me">Mobirise</a></section><section class="header4 cid-qQBUaa6gmL mbr-parallax-background" id="header4-j">
